...
func init() {
	...
	gitCmd.PersistentFlags().StringVarP(&gitAccess.Owner, "owner", "o", "harshanarayana", "GitHub Repo Owner")
	gitCmd.PersistentFlags().StringVarP(&gitAccess.Repo, "repo", "r", "k8s-enhancements", "GitHub Repository")
